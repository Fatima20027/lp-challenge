        ...
        {visibleCourses.map((card) => (
            ...
            <div className=" mt-1  p-4 space-y-4 ring rounded-2xl  text-gray-600">
              ...
              <div className="flex gap-5 md:text-sm">
                <div className="flex">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 relative top-0.5 right-1">
              ...
              <div className="flex justify-between">
                ...
                <button class=" text-sm group relative inline-flex px-4 py-2 items-center justify-center overflow-hidden rounded-full bg-orange-400   text-neutral-200 font-bold cursor-pointer  hover:brightness-95 shadow-md shadow-orange-400/30">
