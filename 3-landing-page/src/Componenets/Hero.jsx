...
const Hero= () => {
  ...
  return (
    <div className=" md:text-start text-white font-medium space-y-2 md:w-[30rem] md:translate-x-7  px-2 md:translate-y-10  translate-y-15 ">
        ...
        <WhatsappLink>
          <button class="group relative inline-flex px-6 py-2 items-center justify-center overflow-hidden rounded-full bg-orange-400   text-neutral-200 font-bold cursor-pointer translate-y-5 hover:brightness-95 shadow-md shadow-orange-400/30">
          
          <span>Register Now</span><div class="ml-1 transition group-hover:translate-x-1 "><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
