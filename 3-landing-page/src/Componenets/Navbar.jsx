  ...
  return (
    <nav className="p-2  sticky top-0 z-50  px-2">
      ...
      `}>
        ...
        <button className=" flex justify-center mt-5 w-full py-3 border border-slate-900 hover:text-slate-900 hover:bg-transparent font-bold rounded-full shadow-sm active:scale-95 transition-transform">
