  ...
  return (
    <nav className="p-2  sticky top-0 z-50  px-2">
      ...
      <div className="hidden md:flex justify-between bg-white/30 backdrop-blur-md border-gray-200/10  rounded-full p-2 px-10 shadow-xl/30"> 
        ...
        <button className="flex px-6 py-2  text-white bg-slate-900 font-bold rounded-full    shadow-sm  transition-colors cursor-pointer border border-slate-900 hover:brightness-130 duration-300   ">
      ...
      `}>
        ...
        <button className=" flex justify-center mt-5 w-full py-3 text-white  bg-slate-900 focus:brightness-130   font-bold rounded-full shadow-sm active:scale-95 transition-transform duration-300">
